...
export default function ContactSection({ title = "Ready to Get Started?", subtitle }) {
  return (
    <section className="bg-gradient-to-br from-mauve-400 to-mauve-500 py-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <a
              ...
              className="flex items-center space-x-2 bg-azure hover:bg-azure-dark text-white px-8 py-4 rounded-full text-lg font-medium transition-all shadow-lg hover:shadow-xl hover:scale-105"
            >
